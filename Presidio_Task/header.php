...
<html>
<head>
<title>Presidio Company Task</title>
...
<body>
<div class="header">
	<div class="header-top" style="background-color:black;color:white;">
		<div class="wrap" >
			<div class="h-logo">
			<a href="index.php"><img src="images/arc-logo.png" alt="Logo Image Here" sytle=""/></a>
		</div>
			  <div class="nav-wrap">
        ...
        $user=mysqli_fetch_array($us);?><a href="profile.php"><?php echo $user['name'];?></a><a href="logout.php">Logout</a><?php }else{?><a href="login.php">Login</a> <a href="registration.php">Register</a><?php }?></li>
 			...
 			<div class="clear"  style="background-color:black;color:white;"></div>
